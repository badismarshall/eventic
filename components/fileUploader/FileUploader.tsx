        ...
        <Card className="mt-3  h-[265px]">
            <CardContent className="w-full h-full p-5">
                <div className="border-2 border-dashed border-gray-200 rounded-lg flex flex-col gap-1 p-6 items-center h-full justify-center">
                    ...
                    <span className="text-xs text-gray-500">Cliquez ou faites glisser pour remplacer</span>
                </div>
            </CardContent>
        </Card>
        </>
        ...
        <Card className="mt-3 h-[265px]">
            <CardContent className="w-full h-full p-5">
                <div className="border-2 border-dashed border-gray-200 rounded-lg flex flex-col gap-1 p-6 items-center h-full justify-center">
                    ...
                    <span className="text-sm font-medium text-gray-500">Cliquez ou faites glisser pour ajouter un fichier</span>
