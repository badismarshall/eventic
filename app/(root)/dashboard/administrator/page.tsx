          ...
          <div className="mx-auto grid flex-1 auto-rows-max gap-4">
            ...
            <div className="grid gap-4 md:grid-cols-[1fr_250px] lg:grid-cols-3 lg:gap-8">
              <div className="grid auto-rows-max items-start gap-4 lg:col-span-2 lg:gap-8">
                <div className="grid gap-4 md:grid-cols-2 md:gap-2 xl:grid-cols-4">
                    <Card>
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                            <CardTitle className="text-sm font-medium">Événements ajoutés</CardTitle>
                    ...
                    <Card>
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                            <CardTitle className="text-sm font-medium">Évènements à venir</CardTitle>
                    ...
                    <Card>
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                            <CardTitle className="text-sm font-medium">Dates de l'événement</CardTitle>
                ...
                <Card x-chunk="dashboard-07-chunk-0">
                  <CardHeader>
                    ...
                    <CardDescription>
                        Voici un résumé des événements ajoutés, publiés, à venir et les dates de l'événement
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <AdminDashboardTable />
                ...
                <Card x-chunk="dashboard-07-chunk-1">
                  <CardHeader>
                    <CardTitle>Récapitulatif des commandes</CardTitle>
                    <CardDescription>
                        Voici un résumé des commandes passées, payées, en attente de paiement et des billets vendus
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="flex justify-center">
                    <ChartContainer config={chartConfig} className="min-h-[200px] w-auto">
                        <LineChart
                            accessibilityLayer
                            data={chartData}
                            margin={{
                ...
                <div className="grid gap-4 md:grid-cols-2 md:gap-2 xl:grid-cols-4">
                    ...
                    <Card>
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                            ...
                            <MapPinCheckInside className="h-4 w-4 text-muted-foreground" />
                        </CardHeader>
                        <CardContent>
                            <div className="text-2xl font-bold">15</div>
                        </CardContent>
